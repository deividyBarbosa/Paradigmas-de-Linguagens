...
from li1.plp.expressions2.memory.ContextoExecucao import ContextoExecucao
from li1.plp.expressions2.memory.VariavelNaoDeclaradaException import VariavelNaoDeclaradaException
from li1.plp.imperative1.memory.AmbienteExecucaoImperativa import AmbienteExecucaoImperativa
